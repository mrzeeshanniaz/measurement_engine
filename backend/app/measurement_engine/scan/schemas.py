...
class ManualMeasurementRequest(BaseModel):
    ...
    M03_waist:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M03"][0], lt=_MANUAL_RANGES["M03"][1])
    M04_abdomen:     Optional[float] = Field(None, gt=_MANUAL_RANGES["M04"][0], lt=_MANUAL_RANGES["M04"][1])
    M05_hips:        Optional[float] = Field(None, gt=_MANUAL_RANGES["M05"][0], lt=_MANUAL_RANGES["M05"][1])
    M06_neck:        Optional[float] = Field(None, gt=_MANUAL_RANGES["M06"][0], lt=_MANUAL_RANGES["M06"][1])
    M07_bicep:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M07"][0], lt=_MANUAL_RANGES["M07"][1])
    M08_wrist:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M08"][0], lt=_MANUAL_RANGES["M08"][1])
    M09_thigh:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M09"][0], lt=_MANUAL_RANGES["M09"][1])
    M10_mid_thigh:   Optional[float] = Field(None, gt=_MANUAL_RANGES["M10"][0], lt=_MANUAL_RANGES["M10"][1])
    M11_knee:        Optional[float] = Field(None, gt=_MANUAL_RANGES["M11"][0], lt=_MANUAL_RANGES["M11"][1])
    M12_calf:        Optional[float] = Field(None, gt=_MANUAL_RANGES["M12"][0], lt=_MANUAL_RANGES["M12"][1])
    M13_ankle:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M13"][0], lt=_MANUAL_RANGES["M13"][1])
    M15_shoulder_to_waist_front: Optional[float] = Field(None, gt=_MANUAL_RANGES["M15"][0], lt=_MANUAL_RANGES["M15"][1])
    M16_shoulder_to_waist_back:  Optional[float] = Field(None, gt=_MANUAL_RANGES["M16"][0], lt=_MANUAL_RANGES["M16"][1])
    M17_kameez_length:           Optional[float] = Field(None, gt=_MANUAL_RANGES["M17"][0], lt=_MANUAL_RANGES["M17"][1])
    M18_dress_length:            Optional[float] = Field(None, gt=_MANUAL_RANGES["M18"][0], lt=_MANUAL_RANGES["M18"][1])
    M19_sleeve_length:           Optional[float] = Field(None, gt=_MANUAL_RANGES["M19"][0], lt=_MANUAL_RANGES["M19"][1])
    M20_sleeve_length_elbow:     Optional[float] = Field(None, gt=_MANUAL_RANGES["M20"][0], lt=_MANUAL_RANGES["M20"][1])
    M21_inseam:                  Optional[float] = Field(None, gt=_MANUAL_RANGES["M21"][0], lt=_MANUAL_RANGES["M21"][1])
    M22_outseam:                 Optional[float] = Field(None, gt=_MANUAL_RANGES["M22"][0], lt=_MANUAL_RANGES["M22"][1])
    M23_crotch_depth_front:      Optional[float] = Field(None, gt=_MANUAL_RANGES["M23"][0], lt=_MANUAL_RANGES["M23"][1])
    M24_crotch_depth_back:       Optional[float] = Field(None, gt=_MANUAL_RANGES["M24"][0], lt=_MANUAL_RANGES["M24"][1])
    M25_torso_length:            Optional[float] = Field(None, gt=_MANUAL_RANGES["M25"][0], lt=_MANUAL_RANGES["M25"][1])
    M26_shoulder_width:          Optional[float] = Field(None, gt=_MANUAL_RANGES["M26"][0], lt=_MANUAL_RANGES["M26"][1])
    M27_chest_width:             Optional[float] = Field(None, gt=_MANUAL_RANGES["M27"][0], lt=_MANUAL_RANGES["M27"][1])
    M28_back_width:              Optional[float] = Field(None, gt=_MANUAL_RANGES["M28"][0], lt=_MANUAL_RANGES["M28"][1])
    M29_hip_width:               Optional[float] = Field(None, gt=_MANUAL_RANGES["M29"][0], lt=_MANUAL_RANGES["M29"][1])
    M30_chest_depth:             Optional[float] = Field(None, gt=_MANUAL_RANGES["M30"][0], lt=_MANUAL_RANGES["M30"][1])
    M31_waist_depth:             Optional[float] = Field(None, gt=_MANUAL_RANGES["M31"][0], lt=_MANUAL_RANGES["M31"][1])
    M32_armhole_depth:           Optional[float] = Field(None, gt=_MANUAL_RANGES["M32"][0], lt=_MANUAL_RANGES["M32"][1])
